...
public class ImmersiveEngineeringHullTypes {
    private static final DeferredRegister<HullType> HULL_TYPES = DeferredRegister.create(HullType.class, TransportImmersiveEngineering.ID);
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, TransportImmersiveEngineering.ID);
    ...
    public static final RegistryObject<HullType> TREATED_WOOD = HULL_TYPES.register("treated_wood",
            () -> new HullType(() -> TREATED_WOOD_PLANKS.orElse(Items.AIR),
                    () -> new ResourceLocation(TransportImmersiveEngineering.ID, "textures/entity/treated_wood_boat.png")));
